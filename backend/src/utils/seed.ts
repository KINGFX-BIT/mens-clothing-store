...
const brands = [
  ...
  { name: "Levis", slug: 'levis', description: 'Iconic denim brand' },
...
const products = [
  ...
  { name: 'Levis 511 Slim Fit Jeans', description: 'Classic slim fit denim', price: 69.99, category: 'Jeans', brand: 'Levis', sizes: ['30', '32', '34', '36'], colors: ['Blue', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-JN-001', featured: true, bestseller: true, newArrival: false },
  { name: 'Levis 501 Original Jeans', description: 'Iconic straight fit jeans', price: 79.99, category: 'Jeans', brand: 'Levis', sizes: ['30', '32', '34', '36'], colors: ['Blue', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-JN-002', featured: false, bestseller: true, newArrival: false },
  { name: 'Levis Graphic T-Shirt', description: 'Logo graphic tee', price: 29.99, category: 'T-Shirts', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'White', 'Navy'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-TS-001', featured: false, bestseller: false, newArrival: false },
  { name: 'Levis Denim Trucker Jacket', description: 'Classic trucker jacket', price: 98.99, category: 'Jackets', brand: 'Levis', sizes: ['M', 'L', 'XL'], colors: ['Beige', 'Navy', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-JK-001', featured: true, bestseller: false, newArrival: false },
  { name: 'Levis Western Shirt', description: 'Snap button western shirt', price: 59.99, category: 'Shirts', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Beige', 'Navy', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-SH-001', featured: false, bestseller: false, newArrival: true },
  { name: 'Levis Relaxed Fit Hoodie', description: 'Comfortable hoodie', price: 54.99, category: 'Hoodies', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'White', 'Navy'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-HD-001', featured: false, bestseller: false, newArrival: false },
  { name: 'Levis Chino Pants', description: 'Modern chino pants', price: 64.99, category: 'Pants', brand: 'Levis', sizes: ['30', '32', '34', '36'], colors: ['Beige', 'Navy', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-PT-001', featured: false, bestseller: false, newArrival: false },
  { name: 'Levis Denim Shorts', description: '501 hemmed shorts', price: 54.99, category: 'Shorts', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Beige', 'Navy', 'Black'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-SH-002', featured: false, bestseller: false, newArrival: false },
  { name: 'Levis Logo Hoodie', description: 'Logo front hoodie', price: 64.99, category: 'Hoodies', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'White', 'Navy'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-HD-002', featured: false, bestseller: false, newArrival: false },
  { name: 'Levis Vintage Tee', description: 'Vintage wash t-shirt', price: 34.99, category: 'T-Shirts', brand: 'Levis', sizes: ['S', 'M', 'L', 'XL'], colors: ['Black', 'White', 'Navy'], images: ['https://images.unsplash.com/photo-1521572163474-6864f9cf17ab'], stock: 50, sku: 'LEVIS-TS-002', featured: false, bestseller: false, newArrival: false },
